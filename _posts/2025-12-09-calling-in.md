...
This is not a time to cut people out of your life for differing views, if half the country voted (in a democratic process) for a convicted  felon to lead them - the issue is not the people. The issue is the system, and we need to fix it together. We cannot find solutions without communicating across party lines and political divides.
...
Let's call people in! Please watch this video for more on what it means to "call in" those we disagree with: https://www.ted.com/talks/loretta_j_ross_don_t_call_people_out_call_them_in
